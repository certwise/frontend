                ...
                <div>
                    ...
                    <form className='mt-5 p-2 border-2 border-primary '>
                        ...
                        <div className='m-2  '>
                            ...
                            <input className='input  border-2 border-primary w-2/5' type="text" placeholder="Name"
                                onChange={(e) => {
                        ...
                        <div className='m-2  '>
                            ...
                            <input className=' input  border-2 border-primary w-2/5' type="email" placeholder="Email"
                                onChange={(e) => {
                            ...
                            templateFields.map(field => {
                                return (
                                    <div
                                        ...
                                        <input className=' input  border-2 border-primary w-2/5'
                                            type="text"
                                            placeholder={field}
                                            onChange={(e) => {
