...
import Modal from "../../utils/home/Modal";
					...
					<div>
						...
						>
							<div className="flex flex-col justify-center">
								<img
									className="mx-auto"
									src={require("../../images/home/hero-image.png").default}
									width="768"
									height="432"
									alt="Hero"
								/>
							...
							>
								<svg
									className="w-6 h-6 fill-current text-gray-400 group-hover:text-indigo-600 flex-shrink-0"
									viewBox="0 0 24 24"
									xmlns="http://www.w3.org/2000/svg"
								>
