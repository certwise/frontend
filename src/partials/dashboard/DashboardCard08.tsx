	...
	const chartData = {
		...
		datasets: [
			...
			// Blue line
			{
				...
				borderColor: (tailwindConfig() as any).theme.colors.blue[400],
				fill: false,
				borderWidth: 2,
				tension: 0,
				pointRadius: 0,
				pointHoverRadius: 3,
				pointBackgroundColor: (tailwindConfig() as any).theme.colors.blue[400],
			},
			// Green line
			{
				label: "Average",
				...
				borderColor: (tailwindConfig() as any).theme.colors.green[500],
				fill: false,
				borderWidth: 2,
				tension: 0,
				pointRadius: 0,
				pointHoverRadius: 3,
				pointBackgroundColor: (tailwindConfig() as any).theme.colors.green[500],
			},
		],
	};
