...
function DropdownMapping({
	...
	return (
		<div className="relative inline-flex w-full flex-grow">
			<button
				ref={trigger}
				className="btn w-full justify-between min-w-56 bg-white border-gray-200 hover:border-gray-300 text-gray-500 hover:text-gray-600"
				aria-label="Select date range"
				aria-haspopup="true"
				onClick={() => setDropdownOpen(!dropdownOpen)}
				aria-expanded={dropdownOpen}
			>
				<div className="text-blue-600 font-bold w-full">
