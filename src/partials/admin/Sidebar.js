    ...
    <div className="lg:w-64">
      ...
      <div
        className={`fixed inset-0 bg-gray-900 bg-opacity-30 z-40 lg:hidden 
                  lg:z-auto transition-opacity duration-200 
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto 
            lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar 
            w-64 flex-shrink-0 bg-gray-800 p-4 transition-transform duration-200 ease-in-out 
      ...
      >
        ...
        <div>
          ...
          <ul className="mt-3">
            {/* Dashboard */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'admin' && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'admin' && 'hover:text-gray-200'}`}>
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'templates' && 'bg-gray-900'}`}>
              <NavLink exact to="/templates" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'templates' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                  </svg>
            ...
            {/* Certificates */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'certificates' && 'bg-gray-900'}`}>
              <NavLink exact to="/certificates" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'certificates' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                  </svg>
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'orders' && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'orders' && 'hover:text-gray-200'}`}>
                <div className="flex items-center justify-between">
                  <div className="flex flex-grow">
                    ...
                    <span className="text-sm font-medium">Certificate Orders</span>
                  </div>
                  {/* Badge */}
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page.startsWith('team-') && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page.startsWith('team-') && 'hover:text-gray-200'}`}>
                <div className="flex items-center justify-between">
                  <div className="flex flex-grow">
                    ...
                    <span className="text-sm font-medium">Your Instituition</span>
                  </div>
                  {/* Icon */}
                  <div className="flex flex-shrink-0 ml-2">
              ...
              <ul className={`pl-9 mt-1 ${!page.startsWith('team-') && 'hidden'}`}>
                <li className="mb-1 last:mb-0">
                  <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'team-tabs' && 'text-indigo-400 hover:text-indigo-400'}`}>
                    <span className="text-sm font-medium">Team - Tabs</span>
                  </NavLink>
                </li>
                <li className="mb-1 last:mb-0">
                  <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150" ${page === 'team-tiles' && 'text-indigo-400 hover:text-indigo-400'}`}>
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'messages' && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'messages' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'tasks' && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'tasks' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'settings' && 'bg-gray-900'}`}>
              <NavLink exact to="/admin" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'settings' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
