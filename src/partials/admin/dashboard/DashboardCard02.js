...
import Icon from '../../../images/admin/icon-02.svg';
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">Template 2</h2>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">Created at</div>
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 mr-2">Number of certs</div>
