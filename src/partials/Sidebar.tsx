				...
				<div className="space-y-8">
					...
					<div>
						...
						<ul className="mt-3">
							...
							<li
								className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
									pathname === "/templates" && "bg-gray-900"
								}`}
							>
								<NavLink
									exact
									to="/templates"
									className={`block text-gray-200 hover:text-white truncate transition duration-150 ${
										pathname === "/templates" && "hover:text-gray-200"
									}`}
								>
									<div className="flex items-center">
										<div className="flex items-center">
							...
							{/* Certificates */}
							<SidebarLinkGroup
								activecondition={pathname.includes("certificates")}
							>
							...
							{/* recipients */}
							<SidebarLinkGroup
								activecondition={pathname.includes("recipients")}
							>
								{(handleClick: any, open: any) => {
									return (
										<React.Fragment>
									...
									return (
										<React.Fragment>
											<a
												href="#0"
												className={`block text-gray-200 hover:text-white truncate transition duration-150 ${
													pathname.includes("account") && "hover:text-gray-200"
												}`}
												onClick={(e) => {
													e.preventDefault();
													sidebarExpanded
