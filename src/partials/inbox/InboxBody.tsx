...
function InboxBody({ inboxSidebarOpen, setInboxSidebarOpen }: any) {
	const mails = [
		{
			id: "0",
			open: false,
			...
			<div className="sticky bottom-0">
				<div className="flex items-center justify-between bg-white border-t border-gray-200 px-4 sm:px-6 md:px-5 h-16">
					...
					<form className="flex-grow flex">
						...
						<button
							type="submit"
							className="btn bg-blue-500 hover:bg-blue-600 text-white whitespace-nowrap"
						>
							Send -&gt;
						</button>
					</form>
