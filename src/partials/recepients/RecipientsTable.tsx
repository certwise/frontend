...
function RecipientsTable({ recipients }: { recipients: recipient[] }) {
	...
	const organization: organization = organizationObj.data?.data;
										...
										<label className="inline-flex">
											...
											<input
												...
												onChange={(e) => {
													e.target.checked &&
														dispatch(
															actions.recipients.setSelectedRecipients(
																recipients
															)
														);
													!e.target.checked &&
