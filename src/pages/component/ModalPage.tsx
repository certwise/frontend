...
function ModalPage() {
	...
	const [scrollbarModalOpen, setScrollbarModalOpen] = useState<any>(false);
	const [cookiesModalOpen, setCookiesModalOpen] = useState<any>(false);
	const [successModalOpen, setSuccessModalOpen] = useState<any>(false);
	const [dangerModalOpen, setDangerModalOpen] = useState<any>(false);
	const [infoModalOpen, setInfoModalOpen] = useState<any>(false);
	const [feedbackModalOpen, setFeedbackModalOpen] = useState<any>(false);
	const [newsletterModalOpen, setNewsletterModalOpen] = useState<any>(false);
	const [announcementModalOpen, setAnnouncementModalOpen] =
		useState<any>(false);
	const [integrationModalOpen, setIntegrationModalOpen] = useState<any>(false);
	const [newsModalOpen, setNewsModalOpen] = useState<any>(false);
	const [planModalOpen, setPlanModalOpen] = useState<any>(false);
	const [searchModalOpen, setSearchModalOpen] = useState<any>(false);
											...
											>
												<div className="p-5 flex space-x-4">
													...
													<div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-blue-100">
														<svg
															className="w-4 h-4 flex-shrink-0 fill-current text-blue-500"
															viewBox="0 0 16 16"
														>
											...
											>
												...
												<div className="text-center">
													...
													<form className="flex max-w-sm m-auto">
														...
														<button
															type="submit"
															className="btn-sm bg-blue-500 hover:bg-blue-600 text-white whitespace-nowrap"
														>
															Subscribe
														</button>
													</form>
															...
															<li>
																<button className="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-blue-400 shadow-sm duration-150 ease-in-out">
																	<div className="flex items-center">
																		<div className="w-4 h-4 border-4 border-blue-500 rounded-full mr-3"></div>
