		...
		<div className="flex h-screen overflow-hidden">
			...
			<div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
				...
				<main>
					...
					{!recipients.isLoading && recipients.data?.data.length === 0 && (
						<EmptyState
							title={"No Recipients found."}
							description="Add recipients to get started."
						...
						<div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
							...
							<div className="sm:flex sm:justify-between sm:items-center mb-8">
								...
								<div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
									...
									<DeleteButton
										selectedItems={
											store.recipients.selected.recipients.map(
												(x) => x._id
											) || [""]
										}
									/>
							...
							{store.recipients.selected.recipients.length > 0 &&
								groups.data?.data.length === 0 && (
									<div className="my-2 text-blue-500 font-bold">
										Create a group to add recipients
									</div>
								)}
