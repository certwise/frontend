...
function Calendar() {
	...
	const [month, setMonth] = useState<any>(today.getMonth());
	// eslint-disable-next-line no-unused-vars
	const [year, setYear] = useState<any>(today.getFullYear());
	const [daysInMonth, setDaysInMonth] = useState<any>([]);
	const [startingBlankDays, setStartingBlankDays] = useState<any>([]);
	const [endingBlankDays, setEndingBlankDays] = useState<any>([]);
	const events = [
		// Previous month
		{
			eventStart: new Date(
					...
					<div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
						...
						<div className="bg-white rounded-sm shadow overflow-hidden">
							...
							<div className="grid grid-cols-7 gap-px bg-gray-200">
								...
								{startingBlankDays.map((blankday: any) => {
									return (
										<div
								...
								{endingBlankDays.map((blankday: any) => {
									return (
										<div
											className="bg-gray-50 h-20 sm:h-28 lg:h-36"
											key={blankday}
